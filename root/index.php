          ...
          <div class="outer-container">
               <div class="container">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                         ...
                         <div class="button">
                              <button id="btn" name="register" type="submit">
          ...
          <div class="footer-row">
               ...
               <!-- <div class="footer-right">
                    ...
                    <p>
                         ...
                         suscipit molestiae in? <i class="fa fa-paper-plane"></i>
                    </p>
                    <p>Lorem ipsum dolor sit.<i class="fa fa-paper-plane"></i></p>
                    <p>
                         Lorem ipsum dolor sit amet consectetur.<i class="fa fa-paper-plane"></i>
                    </p>
               </div> -->
          </div>
